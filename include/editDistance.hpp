...
namespace AASS{
	...
	namespace RSI{
		...
		inline double editDistanceNeighborhood(const std::deque<ModifyTypeElement>& string_to_modify, const std::deque<UnchangedTypeElement>& unchanged, std::function<double(ModifyTypeElement, UnchangedTypeElement)> compareFunction, std::string& out){
